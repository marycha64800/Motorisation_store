...
// ----- AUTRE CONFIGURATION --------
#define SPEED_VAR 37                                                       // modifier le delais entre chaque monter en tension 
#define NB_ENGINES 4
#define ADJUST_VOLTAGE 127                                                 // TENSION DE DEPART ET DE RALENTISSEMNT DES MOTEURS 
#define NB_LOOP_SPEED_VAR (255 - ADJUST_VOLTAGE)
#define TIME_LOOP_ONE_LOOP (NB_LOOP_SPEED_VAR * SPEED_VAR)
#define TIME_IN_LOOP (TIME_LOOP_ONE_LOOP*2)*NB_ENGINES
enum {CLOSE, OPEN};
